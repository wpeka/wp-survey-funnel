										...
										<div class="surveyfunnel-lite-post-status-inside --surveyfunnel-lite-flex">
											...
											<div class="--surveyfunnel-lite-flex surveyfunnel-lite-post-icons <?php echo esc_html( $tooltip_class ); ?>">
												<span  class="surveyfunnel-lite-tooltip">
													...
													<span class="surveyfunnel-lite-tooltiptext"><?php $dis ? esc_html_e( $tooltip_text ) : esc_html_e( 'Build', 'surveyfunnel' ); ?></span>
												</span>
												<span  class="surveyfunnel-lite-tooltip">
													...
													<span class="surveyfunnel-lite-tooltiptext"><?php $dis ? esc_html_e( $tooltip_text ) : esc_html_e( 'Design', 'surveyfunnel' ); ?></span>
												</span>
												<span  class="surveyfunnel-lite-tooltip">
													...
													<span class="surveyfunnel-lite-tooltiptext"><?php $dis ? esc_html_e( $tooltip_text ) : esc_html_e( 'Configure', 'surveyfunnel' ); ?></span>
												</span>
												<span  class="surveyfunnel-lite-tooltip">
													...
													<span class="surveyfunnel-lite-tooltiptext"><?php $dis ? esc_html_e( $tooltip_text ) : esc_html_e( 'Deploy', 'surveyfunnel' ); ?></span>
												</span>
												<span  class="surveyfunnel-lite-tooltip">
													...
													<span class="surveyfunnel-lite-tooltiptext"><?php $dis ? esc_html_e( $tooltip_text ) : esc_html_e( 'Reports', 'surveyfunnel' ); ?></span>
												</span>
												<span  class="surveyfunnel-lite-tooltip">
