			...
			return (
				<>
					<div className             = "modalOverlay">
						...
						<h3> Content Elements & nbsp; & #62; & nbsp;  Form Elements & nbsp; & #62; & nbsp;  {this.state.title} { this.state.currentFormElement ? <span> & nbsp; & #62; & nbsp;  {this.state.currentFormElement.name} </ span> : ""} </ h3>
							<CloseModal />
						</ div>
